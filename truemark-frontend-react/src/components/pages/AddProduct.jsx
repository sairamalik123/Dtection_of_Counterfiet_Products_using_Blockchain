...
// //   const generateQRCode = async (serialNumber) => {
// //   const url = `${window.location.origin}/product/${serialNumber}`;
// //   setQrData(url);
// // };


// const generateQRCode = async (serialNumber) => {
//   // Option 1: Generate simple CSV format for compatibility
//   const data = `${CONTRACT_ADDRESS},${serialNumber}`;
//   setQrData(data);
  
//   // Option 2: If you want to use digital signatures, uncomment below:
//   try {
...
//       // ✅ Use the serial number from database, not from input field
...
//   // ✅ FIXED: Remove serialNumber from request body since backend generates it
...
//       // ✅ Add product to database and get the generated serial number
