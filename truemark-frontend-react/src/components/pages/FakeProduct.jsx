...
//             <Paper elevation={3} sx={{ width: "450px", margin: "auto", marginTop: "0.5%", padding: "3%", backgroundColor: "#e3eefc" }}>
//                 <Typography
//                     variant="h4"
//                     sx={{
...
import bgImg from '../../img/bg.png';
import { useNavigate, useLocation } from 'react-router-dom'; // useLocation to get QR data if needed
