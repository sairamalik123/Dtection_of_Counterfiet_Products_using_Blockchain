...
>
    ...
    <Container component="main" maxWidth="xs" sx={{ display: "flex", justifyContent: "center", height: "100vh" }}>
        <Box
            sx={{
                boxShadow: 3,
                borderRadius: 2,
        ...
        >
            ...
            <Typography component="h1" variant="h5"
                sx={{
                    textAlign: "center", marginBottom: "3%", marginTop: "3%",
                    fontFamily: 'Gambetta', fontWeight: "bold", fontSize: { xs: "1.8rem", sm: "2.5rem" }
                }}
            >
                TRUEMARK!
            </Typography>
