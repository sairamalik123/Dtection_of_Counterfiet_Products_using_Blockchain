...
// const storageProduct = multer.diskStorage({
//     destination: path.join(__dirname, 'public/upload/product'),
//     filename: (req, file, cb) => {
//         cb(null, file.originalname);
//     }
// })
...
// app.get('/file/profile/:fileName', function (req, res) {
//     const {fileName} = req.params;
//     const filePath = path.join(__dirname, 'public/upload/profile', fileName);
//     res.sendFile(filePath);
// });

// app.get('/file/product/:fileName', function (req, res) {
//     const {fileName} = req.params;
//     const filePath = path.join(__dirname, 'public/upload/product', fileName);
//     res.sendFile(filePath);
// });
